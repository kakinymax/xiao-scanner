...
void drawGraphScreen(int mode, float t, float h) {
  ...
  char title[24];
  sprintf(title, "%s %dh/%dh", names[mode], elapsedH, rangeH[trend_range]);
...
void drawExportScreen() {
  ...
  u8g2.drawStr(0, 60, "Starting in 2s...");
  u8g2.sendBuffer();
  delay(2000);
